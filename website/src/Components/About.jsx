        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-[rgba(255,255,255,0.04)] h-90 shadow-3xl p-5 flex flex-col hover:-translate-y-4 transition-all duration-300 cursor-pointer">
            ...
            <div className="justify-center">
              ...
              At Kutumba Tech, We are a team of passionate and dedicated software engineers, designers, and innovators committed to transforming ideas into cutting-edge digital solutions. Our company provide custom software solutions, serving clients across various industries worldwide.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[rgba(255,255,255,0.04)] h-90 shadow-3xl p-8 flex flex-col hover:-translate-y-4 transition-all duration-300 cursor-pointer">
            ...
            <div className="justify-center">
              <p className="mt-2 text-black text-lg mb-7 text-start">
              Our mission is to empower businesses by delivering innovative and reliable software products that drive efficiency, enhance user experience, and foster growth. We believe in the power of technology to solve complex problems and create opportunities for our clients.
              </p>
            </div>
          </div>
